...
- Stand up and publish a documentation / marketing website for markdown-contract (Astro), building as a project in the moon monorepo ([[D-0010-monorepo-tooling]]). Sequenced ahead of the full example use-case catalog ([[M-0008-example-use-case-catalog]]), which becomes its content basis. ^summary
...
**Out:** the full categorized use-case catalog ([[M-0008-example-use-case-catalog]]); the local daemon web UI / vault dashboard (later/tbd — a separate Nuxt app).
