...
Author a new decision record under `provenance/` (the next free `D-00NN`; `provenance/d0016/` proposed) following the `provenance/d0015/` format (README decision record + `proposed-shape.md` companion). It resolves the open design questions and lands a recommendation (ship / defer / reject), plus scoped follow-on task stubs if it recommends shipping. The questions to decide:
...
2. Draft the decision record at `provenance/d0016/README.md` in the `d0015` format (Summary / Context / Decision / Why / Options considered / Out of scope / Assumptions), resolving the four questions above with a concrete recommendation.
3. Draft the `provenance/d0016/proposed-shape.md` companion sketching the recommended paragraph-leaf API + a worked read-back example (non-normative).
...
|---|---|---|
| `provenance/d0016/README.md` | new | The paragraph-transform decision record (Summary / Context / Decision / Why / Options / Out of scope / Assumptions) |
| `provenance/d0016/proposed-shape.md` | new | Non-normative API sketch + worked read-back example for the recommended option |
