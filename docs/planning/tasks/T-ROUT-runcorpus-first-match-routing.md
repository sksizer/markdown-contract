...
`EMBED-AND-CI-03`, and `REAL-WORLD-SCHEMAS-11` in [[M-0010-example-use-case-catalog]].
...
Closes a test gap identified by [[M-0010-example-use-case-catalog]]; concerns the corpus
