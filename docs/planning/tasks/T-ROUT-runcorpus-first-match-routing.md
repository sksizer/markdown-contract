...
`EMBED-AND-CI-03`, and `REAL-WORLD-SCHEMAS-11` in [[M-0003-example-use-case-catalog]].
...
Closes a test gap identified by [[M-0003-example-use-case-catalog]]; concerns the corpus
