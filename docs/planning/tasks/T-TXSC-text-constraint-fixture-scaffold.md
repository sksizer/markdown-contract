...
completion_note: 'Shipped via #65. Landed the gated text-constraint fixture scaffold,
  the text-api/text-yaml enable gates (both false), and the no-op text-constraints
  stub.'
---
