...
//! rejected at compile time as typed [`DeclarativeError`]s. The envelope speaks
//! `mcVersion: 2`, the JSON-Schema-idiom vocabulary (`schema_v2` / `body_v2`); v1 is
//! retired (D-0020 — the envelope gate names the codemod).
//!
