...
Contributor-facing detail for the markdown-contract workspace: the quality
baseline, the toolchain, and how to author moon tasks correctly. For what the
project *is*, start with [README.md](README.md); for module and test
