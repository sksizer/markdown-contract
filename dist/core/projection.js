...
function projectParagraph(node) {
...
function buildTree(root) {
    ...
    for (const node of root.children) {
        ...
        if (!block)
            continue; // D4: blockquote / nested content yields no section-level block
