...
export interface SectionGroup {
    ...
    [key: string]: SectionView | TableView<Record<string, string>> | SectionView[] | ((name: string) => SectionView | undefined) | undefined;
}
/**
...
export interface SectionView {
    ...
    [key: string]: string | SourcePos | string[] | TableView<Record<string, string>> | TableView<Record<string, string>>[] | ListView[] | SectionGroup | ((scope?: "prose" | "all") => string) | ((id: string) => BlockView | undefined) | undefined;
}
