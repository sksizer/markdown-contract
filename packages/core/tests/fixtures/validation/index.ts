...
// `./text/` subdirectory to dodge the yaml-parity "peers exist" check. v27–v28 are the
// mcVersion 2 parity fixtures (D-0020): description→hint and minContains/maxContains.
...
import v27 from "./27-v2-description-hint.js";
import v28 from "./28-v2-min-max-contains.js";
