 ...
 *
 * The category order is the curriculum spine (rung 1 → 8); it drives the sidebar
 * and the landing-page hero tour.
 */
...
/** The curriculum spine: category keys in rung order 1 → 8. */
